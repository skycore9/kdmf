...
{
    printf(
    "usage: kdmf train [options] binary_train_file [model]\n"
    "\n"
    "options:\n"
    "-k <features>: set the number of latent features (default 40)\n"
    "-t <iterations>: set the number of iterations (default 40)\n"
    "-s <threads>: set the number of threads (default 1)\n"
    "-p <reg_pu>: set the regularization cost for P (default 1)\n"
    "-q <reg_qi>: set the regularization cost for Q (default 1)\n"
